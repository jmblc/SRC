...
public class CrmUtil {
    ...
    public static StringBuilder getTableauFichesAppelsRecherchees(
            Collection fiches_appels_recherchees) {
        ...
        if (fiches_appels_recherchees != null
            ...
            sb.append("<tr>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"DATEAPPEL\")' nowrap='nowrap' align='center'>Date Appel <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"AUTEUR\")' nowrap='nowrap' align='center'>Auteur <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"ID\")' nowrap='nowrap' align='center'>ID Fiche<img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"POLE\")' nowrap='nowrap' align='center'>P&ocirc;le <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"MUTUELLE\")' nowrap='nowrap' align='center'>Mutuelle <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"EG\")' nowrap='nowrap' align='center'>Entit&eacute; de gestion <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"MOTIF\")' nowrap='nowrap' align='center'>Motif <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"SOUSMOTIF\")' nowrap='nowrap' align='center'>Sous-motif<img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"POINT\")' nowrap='nowrap' align='center'>Point <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"SOUSPOINT\")' nowrap='nowrap' align='center'>Sous-point<img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"TYPEAPPELANT\")' nowrap='nowrap' align='center'>Type appelant<img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"CODEADHERENTNUMEROCONTRAT\")' nowrap='nowrap' align='center'>Code adh&eacute;rent<img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierFichesAppelsPar(\"STATUT\")' nowrap='nowrap' align='center'>Statut<img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("</tr>");
            ...
            for (int i = 0; i < fiches_appels_recherchees.size(); i++) {
                ...
                sb.append("<td class='m_td' nowrap='nowrap'>" + appel_id
                        + "</td>");
                sb.append("<td class='m_td' nowrap='nowrap'><img src=\"../img/SCANNER.gif\"  class=\"message_box\" id=\"id_ib_resume_fiche_"
                        + i
    ...
    public static StringBuilder getTableauAssuresRecherches(
            Collection assures_recherches) {
        StringBuilder sb = new StringBuilder("");
        ...
        if (assures_recherches != null && !assures_recherches.isEmpty()) {
            ...
            sb.append("<table class='m_table' cellspacing='0' width='100%'>");
            sb.append("<tr>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"MUTUELLE\")' nowrap='nowrap' align='center'>Mutuelle <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"CODEADHERENTNUMEROCONTRAT\")' nowrap='nowrap' align='center'>Num&eacute;ro adh&eacute;rent <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"CIVILITE\")' nowrap='nowrap' align='center'>Civilit&eacute; <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"NOM\")' nowrap='nowrap' align='center'>Nom <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"PRENOM\")' nowrap='nowrap' align='center'>Pr&eacute;nom <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"QUALITE\")' nowrap='nowrap' align='center'>Qualit&eacute; <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"DATENAISSANCE\")' nowrap='nowrap' align='center'>Date de naissance <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"NUMEROSECU\")' nowrap='nowrap' align='center'>Num&eacute;ro de s&eacute;curit&eacute; sociale <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"RADIE\")' nowrap='nowrap' align='center'>Radi&eacute; <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"OUTILGESTION\")' nowrap='nowrap' align='center'>Outil de gestion <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAssuresPar(\"ENTITEGESTION\")' nowrap='nowrap' align='center'>Entité Gestion <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("</tr>");
            ...
            for (int i = 0; i < assures_recherches.size(); i++) {
                ...
                couleur_ligne = ((assure.getRadie() != null && "0"
                        ...
                        : "m_tr_noir";
                if (assure.getClickable() != null
                        && "C".equals(assure.getClickable())) {
                    fonction_javascript = "Javascript:ficheAppelSetAssure('"
                            + ben_id + "')";
                ...
                sb.append("<td class='m_td' nowrap='nowrap' align='center'>"
                        + ((assure.getRadie() != null && "0".equals(assure
                                .getRadie())) ? "<img src='../img/USER_RADIE.gif' border='0'/>"
                                : "&nbsp;") + "</td>");
                sb.append("<td class='m_td' nowrap='nowrap'>"
            ...
            if (assures_recherches.size() == 1 && assure != null
                    ...
                    && "C".equals(assure.getClickable())) {
                sb.append("<script>");
                sb.append("ficheAppelSetAssure('" + ben_id + "')");
                sb.append("</script>");
            }
    ...
    public static StringBuilder getTableauEntreprisesRecherchees(
            Collection entreprises_recherchees) {
        StringBuilder sb = new StringBuilder("");
        ...
        if (entreprises_recherchees != null
            ...
            sb.append("<table class='m_table' cellspacing='0' width='100%'>");
            sb.append("<tr>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEntreprisesPar(\"MUTUELLE\")' nowrap='nowrap' align='center'>Mutuelle <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEntreprisesPar(\"NOM\")' nowrap='nowrap' align='center'>Nom <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEntreprisesPar(\"NUMEROSIRET\")' nowrap='nowrap' align='center'>Num&eacute;ro siret <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEntreprisesPar(\"CODEETABLISSEMENT\")' nowrap='nowrap' align='center'>Code &eacute;tablissement <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEntreprisesPar(\"CODEENTREPRISE\")' nowrap='nowrap' align='center'>Code entreprise <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEntreprisesPar(\"ENTITEGESTION\")' nowrap='nowrap' align='center'>Entit&eacute; de gestion <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEntreprisesPar(\"CODEPOSTAL\")' nowrap='nowrap' align='center'>Code postal <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEntreprisesPar(\"LOCALITE\")' nowrap='nowrap' align='center'>Localit&eacute; <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEntreprisesPar(\"RADIE\")' nowrap='nowrap' align='center'>Radi&eacute; <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEntreprisesPar(\"OUTILGESTION\")' nowrap='nowrap' align='center'>Outil de gestion <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("</tr>");
            ...
            for (int i = 0; i < entreprises_recherchees.size(); i++) {
                ...
                sb.append("<td class='m_td' nowrap='nowrap' align='center'>"
                        + ((entreprise.getRadie() != null && "0"
                                .equals(entreprise.getRadie())) ? "<img src='../img/USER_RADIE.gif' border='0'/>"
                                : "&nbsp;") + "</td>");
                sb.append("<td class='m_td' nowrap='nowrap'>"
    ...
    public static StringBuilder getTableauAppelantsRecherches(
            Collection appelants_recherches) {
        StringBuilder sb = new StringBuilder("");

        if (appelants_recherches != null && !appelants_recherches.isEmpty()) {
            sb.append("<table class='m_table' cellspacing='0' width='100%'>");
            sb.append("<tr>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAppelantsPar(\"TYPEAPPELANT\")' nowrap='nowrap' align='center'>Type d'appelant <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAppelantsPar(\"CIVILITE\")' nowrap='nowrap' align='center'>Civilit&eacute; <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAppelantsPar(\"NOM\")' nowrap='nowrap' align='center'>Nom <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAppelantsPar(\"PRENOM\")' nowrap='nowrap' align='center'>Pr&eacute;nom <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAppelantsPar(\"ETABLISSEMENTRS\")' nowrap='nowrap' align='center'>Etablissement Raison sociale <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAppelantsPar(\"NUMEROFINESS\")' nowrap='nowrap' align='center'>Num&eacute;ro FINESS <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAppelantsPar(\"NUMEROSECU\")' nowrap='nowrap' align='center'>Num&eacute;ro s&eacute;curit&eacute; sociale <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierAppelantsPar(\"CODEADHERENTNUMEROCONTRAT\")' nowrap='nowrap' align='center'>Code Adh&eacute;rent <img src='../img/SORT_WHITE.gif' border='0'/></td>");
    ...
    public static StringBuilder getTableauEtablissementsHospitaliersRecherches(
            Collection appelants_recherches) {
        StringBuilder sb = new StringBuilder("");
        ...
        if (appelants_recherches != null && !appelants_recherches.isEmpty()) {
            sb.append("<table class='m_table' cellspacing='0' width='100%'>");
            sb.append("<tr>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEtablissementsHospitaliersPar(\"ETABLISSEMENTRS\")' nowrap='nowrap' align='center'>Etablissement Raison sociale  <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEtablissementsHospitaliersPar(\"NUMEROFINESS\")' nowrap='nowrap' align='center'>Num&eacute;ro FINESS <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEtablissementsHospitaliersPar(\"CODEPOSTAL\")' nowrap='nowrap' align='center'>Code postal <img src='../img/SORT_WHITE.gif' border='0'/></td>");
            sb.append("<td class='m_td_entete' onClick='Javascript:trierEtablissementsHospitaliersPar(\"LOCALITE\")' nowrap='nowrap' align='center'>Localit&eacute; <img src='../img/SORT_WHITE.gif' border='0'/></td>");
    ...
    public static File getFicheAppelPDF(String id_fiche) {
        ...
        try{
            ...
            if (appel != null) {
                ...
                date_modification = UtilDate.fmtDDMMYYYYHHMMSS(appel
                        .getDATEMODIFICATION());
                date_cloture = UtilDate.fmtDDMMYYYYHHMMSS(appel.getDATECLOTURE());
    
                if (!"".equals(appel.getCREATEUR_ID())) {
                    TeleActeur teleacteur_auteur = SQLDataService
                            .getTeleActeurById(appel.getCREATEUR_ID());
                ...
                if (!"".equals(appel.getMODIFICATEUR_ID())) {
                    TeleActeur teleacteur_modificateur = SQLDataService
                            .getTeleActeurById(appel.getMODIFICATEUR_ID());
                    if (teleacteur_modificateur != null) {
                        modificateur = " par "
                                + teleacteur_modificateur.getPrenomNom();
                    }
                }
    
                if (!"".equals(appel.getCLOTUREUR_ID())) {
                    TeleActeur teleacteur_clotureur = SQLDataService
                            .getTeleActeurById(appel.getCLOTUREUR_ID());
                ...
                if (!alias_statut.equalsIgnoreCase(IContacts._HORSCIBLE)) {
                    ...
                    // Infos assuré
                    if ("ASSURE".equalsIgnoreCase(alias_type_appelant)) {
                        Beneficiaire assure = SQLDataService
                                .getBeneficiaireById(appel.getBENEFICIAIRE_ID());
                        if (assure != null) {
                            numero_adherent_assure = assure.getCODE();
                            qualite_assure = assure.getQualite();
                            Personne personne_assure = SQLDataService
                                    .getPersonneById(assure.getPERSONNE_ID());
                            if (personne_assure != null) {
                                prenom_nom_assure = personne_assure.getPrenomNom();
                                Adresse adresse = SQLDataService
                                        .getAdresseById(personne_assure
                                                .getADRESSE_ID());
                                if (adresse != null) {
                                    ...
                                    telephones_assure = adresse.getTELEPHONEFIXE()
                                            + ((!"".equals(adresse
                                                    .getTELEPHONEAUTRE())) ? adresse
                                                    .getTELEPHONEAUTRE() : "");
                                }
                    ...
                    // Infos entreprise
                    else if ("ENTREPRISE".equalsIgnoreCase(alias_type_appelant)) {
                        Etablissement etablissement = SQLDataService
                                .getEtablissementById(appel.getETABLISSEMENT_ID());
                        if (etablissement != null) {
                            libelle_entreprise = etablissement.getLIBELLE();
                            entite_gestion_entreprise = etablissement
                                    .getEntiteGestion();
                            numero_siret_entreprise = etablissement.getSIRET();
    
                            Adresse adresse = SQLDataService
                                    .getAdresseById(etablissement.getADRESSE_ID());
                            if (adresse != null) {
                                ...
                                telephones_entreprise = adresse.getTELEPHONEFIXE()
                                        + ((!"".equals(adresse.getTELEPHONEAUTRE())) ? adresse
                                                .getTELEPHONEAUTRE() : "");
                            }
                    ...
                    // Infos appelant
                        ...
                        Appelant appelant = SQLDataService.getAppelantById(appel
                                .getAPPELANT_ID());
                        if (appelant != null) {
                            prenom_nom_appelant = ((!""
                                    .equals(appelant.getPRENOM())) ? appelant.getPRENOM() + " " : "")
                                    + ((!"".equals(appelant.getNOM())) ? appelant
                                            .getNOM() + " " : "");
                            etablissement_rs_appelant = (!"".equals(appelant
                                    .getETABLISSEMENT_RS())) ? appelant
                                    .getETABLISSEMENT_RS() + " " : "";
                            telephones_appelant = appelant.getADR_TELEPHONEAUTRE()
                                    + ((!"".equals(appelant.getADR_TELEPHONEFIXE())) ? appelant
                                            .getADR_TELEPHONEFIXE() : "");
                    ...
                    if ("INSATISFAIT".equals(alias_satisfaction)) {
                        img_satisfaction = "<img src='../img/s_insatisfait_2.gif' title='"
                                + satisfaction + "' align='bottom'/>";
                    } else if ("SATISFAIT".equals(alias_satisfaction)) {
                        img_satisfaction = "<img src='../img/s_satisfait_2.gif' title='"
                                + satisfaction + "' align='bottom'/>";
                    } else if ("NEUTRE".equals(alias_satisfaction)) {
                        img_satisfaction = "<img src='../img/s_neutre_2.gif' title='"
                                + satisfaction + "' align='bottom'/>";
                    } else if ("DANGER".equals(alias_satisfaction)) {
                        img_satisfaction = "<img src='../img/s_danger_2.gif' title='"
                                + satisfaction + "' align='bottom'/>";
                    }
    
                    urgent = ("1".equals(appel.getTRAITEMENTURGENT())) ? "Oui"
                            : "Non";
                    reclamation = ("1".equals(appel.getRECLAMATION())) ? "Oui"
                            : "Non";
                    a_rappeler = (appel.getDATERAPPEL() != null) ? "Oui. Le "
                            + UtilDate.formatDDMMYYYY(appel.getDATERAPPEL()) + " "
                            + appel.getPeriodeRappel() + "" : "Non";
            ...
            table_appelant.getDefaultCell().setVerticalAlignment(
            ...
            if ("ASSURE".equals(alias_type_appelant)) {
                ...
                phrase = new Phrase(new String("Identité".getBytes("utf-8"),
                        Charset.forName(_UTF8)), bleu11);
                cell.setPhrase(phrase);
                table_appelant.addCell(cell);
                ...
                phrase = new Phrase(new String(
                        "Numéro d'adhérent".getBytes("utf-8"),
                        Charset.forName(_UTF8)), bleu11);
                cell.setPhrase(phrase);
                table_appelant.addCell(cell);
                ...
                phrase = new Phrase(new String("Téléphones".getBytes("utf-8"),
                        Charset.forName(_UTF8)), bleu11);
                cell.setPhrase(phrase);
                table_appelant.addCell(cell);
                ...
                cell.setPhrase(phrase);
                table_appelant.addCell(cell);
            } else if ("ENTREPRISE".equals(alias_type_appelant)) {
                phrase = new Phrase("Type", bleu11);
                cell.setPhrase(phrase);
                table_appelant.addCell(cell);
                phrase = new Phrase(type_appelant, noir11);
                ...
                phrase = new Phrase(new String(
                        "Entité de gestion".getBytes("utf-8"),
                        Charset.forName(_UTF8)), bleu11);
                cell.setPhrase(phrase);
                table_appelant.addCell(cell);
                ...
                phrase = new Phrase(new String("Numéro de siret".getBytes("utf-8"),
                        Charset.forName(_UTF8)), bleu11);
                cell.setPhrase(phrase);
                table_appelant.addCell(cell);
                ...
                phrase = new Phrase(new String("Numéro FINESS".getBytes("utf-8"),
                        Charset.forName(_UTF8)), bleu11);
                cell.setPhrase(phrase);
                table_appelant.addCell(cell);
            ...
            phrase = new Phrase(new String("Créée le".getBytes("utf-8"),
                    Charset.forName(_UTF8)), bleu11);
            cell.setPhrase(phrase);
            table_fiche.addCell(cell);
            ...
            cell = new PdfPCell();
            cell.setColspan(2);
            table_scenario.getDefaultCell().setVerticalAlignment(
                    Element.ALIGN_MIDDLE);
            table_scenario.getDefaultCell().setNoWrap(true);
    
            phrase = new Phrase(new String("Scénario".getBytes("utf-8"),
                    Charset.forName(_UTF8)), separateur);
            cell.setPhrase(phrase);
            ...
            cell = new PdfPCell();
            cell.setColspan(2);
            table_cloture.getDefaultCell().setVerticalAlignment(
                    Element.ALIGN_MIDDLE);
            table_cloture.getDefaultCell().setNoWrap(true);
    
            phrase = new Phrase(new String("Clôture".getBytes("utf-8"),
                    Charset.forName(_UTF8)), separateur);
            cell.setPhrase(phrase);
            table_cloture.addCell(cell);
            cell.setColspan(0);
    
            phrase = new Phrase(new String("Transférée à".getBytes("utf-8"),
                    Charset.forName(_UTF8)), bleu11);
            cell.setPhrase(phrase);
            table_cloture.addCell(cell);
            ...
            phrase = new Phrase(new String("Réclamation".getBytes("utf-8"),
                    Charset.forName(_UTF8)), bleu11);
            cell.setPhrase(phrase);
            table_cloture.addCell(cell);
            phrase = new Phrase(reclamation, noir11);
            cell.setPhrase(phrase);
            table_cloture.addCell(cell);
    
            phrase = new Phrase("Urgent", bleu11);
            cell.setPhrase(phrase);
            table_cloture.addCell(cell);
            phrase = new Phrase(urgent, noir11);
            cell.setPhrase(phrase);
            table_cloture.addCell(cell);
    
            phrase = new Phrase(new String("A rappeler ?".getBytes("utf-8"),
                    Charset.forName(_UTF8)), bleu11);
            cell.setPhrase(phrase);
            table_cloture.addCell(cell);
            phrase = new Phrase(a_rappeler, noir11);
            cell.setPhrase(phrase);
            table_cloture.addCell(cell);
    ...
    public static void envoyerFicheDeTransfert(String IDFiche,
            String destinataire_transfert, File fichier,
