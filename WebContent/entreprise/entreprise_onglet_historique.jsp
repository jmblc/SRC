...
%>
	...
	<div id="id_historique_entreprise" class="newScrollBar">													
		<table class="m_table" cellspacing='0' width="100%" border="1">
			<tr>		
				<td class='m_td_entete_sans_main' nowrap='nowrap' align="center">Rang</td>	
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueEntreprise('DATEEVENEMENT')">Date &eacute;v&eacute;nement <img src='../img/SORT_WHITE.gif' border='0'/></td>
				<td class='m_td_entete_sans_main' nowrap='nowrap' align="center" >Type</td>	
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueEntreprise('OBJET')">Objet <img src='../img/SORT_WHITE.gif' border='0'/></td>
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueEntreprise('DETAIL')">D&eacute;tail <img src='../img/SORT_WHITE.gif' border='0'/></td>																
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueEntreprise('QUALITE')">B&eacute;n&eacute;ficiaire <img src='../img/SORT_WHITE.gif' border='0'/></td>	
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueEntreprise('STATUT')">Statut <img src='../img/SORT_WHITE.gif' border='0'/></td>			
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueEntreprise('COMMENTAIRE')">Commentaire <img src='../img/SORT_WHITE.gif' border='0'/></td>	
			</tr>
	...
	<script>
		objet_div = document.getElementById('id_historique_entreprise');
