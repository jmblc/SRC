...
<%
    String prenom_nom_beneficaire = "", infos_eg_sensible = "";
	...
	if(personne != null ){
		prenom_nom_beneficaire = personne.getPrenomNom();
	}
	
	String id_eg_sensible = beneficiaire.getENTITE_GESTION_ID();
...
<table width="100%">
	<tr>
		...
		<td width="10%" align="right"><input type="button" value="Effacer" style="width:75px" class="bouton_bleu" onclick="Javascript:ficheAppelNouvelleRechercheAssure()"></td>
	</tr>
</table>
...
<div style="padding-top:10px">
	<table width="100%" cellpadding="4" cellspacing="2">
		<tr>
			<td class="gris12">Les donn&eacute;es de l'assur&eacute; "<%=prenom_nom_beneficaire %>" (Entit&eacute; de gestion "<%=infos_eg_sensible %>") sont confidentielles et vous n'&ecirc;tes pas habilit&eacute;s &agrave; y acc&eacute;der.</td>
		</tr>
		<tr>
