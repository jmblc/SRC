...
<%
	Collection historique = objet_appelant.getHistorique();
...
%>
	...
	<div id="id_historique_assure" class="newScrollBar">													
		<table class="m_table" cellspacing='0' width="100%" border="1">
			<tr>		
				<td class='m_td_entete_sans_main' nowrap='nowrap' align="center">Rang</td>	
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueAssure('DATEEVENEMENT')">Date &eacute;v&eacute;nement <img src='../img/SORT_WHITE.gif' border='0'/></td>
				<td class='m_td_entete_sans_main' nowrap='nowrap' align="center" >Type</td>	
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueAssure('OBJET')">Objet <img src='../img/SORT_WHITE.gif' border='0'/></td>
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueAssure('DETAIL')">D&eacute;tail <img src='../img/SORT_WHITE.gif' border='0'/></td>																
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueAssure('QUALITE')">B&eacute;n&eacute;ficiaire <img src='../img/SORT_WHITE.gif' border='0'/></td>	
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueAssure('STATUT')">Statut <img src='../img/SORT_WHITE.gif' border='0'/></td>			
				<td class='m_td_entete' nowrap='nowrap' align="center" onClick="Javascript:trierHistoriqueAssure('COMMENTAIRE')">Commentaire <img src='../img/SORT_WHITE.gif' border='0'/></td>	
			</tr>
			...
			<%for(int i=0; i<taille; i++){ 
				...
				<%}					
					...
					else if("changement mot de passe".equalsIgnoreCase(detail)){
						//
						fonction_javascript = "Javascript:ouvrirEvenement('" + ligne_historique.getId() +"', 'L' )";
						icone = "<img src='img/CHANGEMENT_MOT_DE_PASSE.gif' alt='Changement de mot de passe'  border='0'>";
	...
	<script>
		objet_div = document.getElementById('id_historique_assure');
