...
PostItEtablissement postit = SQLDataService.getPostItEtablissement(etablissement_id);
String contenu = "";
if(postit != null ){
...
<html>
 <head>
  	<title>H.Contacts | Postit Entreprise</title>
 ...
 <body>
  ...
  <table width="100%" border="0">
		<tr>
			...
			<td class="titre" align="center">Note Entreprise</td>
   ...
   <table  border="0" align="center">
		<tr>
			...
			<%if( modifiable){ %>
				<td><input type="button" class="bouton_bleu" style="width:75px" value="Supprimer" onclick="Javascript:supprimerPostItEntreprise()"></td>
				<td><input type="button" class="bouton_bleu" style="width:75px" value="Modifier" onclick="Javascript:modifierPostItEntreprise()"></td>
			<%}%>			
		</tr>
	</table>
