...
<form name="CreationMessageForm">

<div class="bleu12IB" style="width:100%;" align="center">CREATION DE MESSAGE</div>
...
<table cellpadding="4" cellspacing="4" border="0" width="100%">		
	...
	<tr>
		...
		<td class="noir11" colspan="2">
			...
			%>
					<option value="<%=laCampagne.getId()%>" class="<%=classe %>"> <%=laCampagne.getLibelle()%></option>
			<%
				}
			%>		
			</select>	
	...
	<tr>
		...
		<td class="noir11"><textarea name="titre" style="width:260px;height:45px" class="text_area_commentaires"></textarea></td>
	...
	<tr>
		...
		<td align="left"><textarea name="contenu" style="width:260px;height:160px" class="text_area_commentaires" ></textarea> </td>	
	...
	<tr>
		...
		<td class="noir11" colspan="2"><input type="text" name="dateDebut" id="date_debut" class="swing11" maxlength="10"/>		
		<a href="#" onClick="Javascript:document.forms['CreationMessageForm'].dateDebut.value=''"><img src="../img/CLEAR.gif" border="0" align="middle"></img></a></td>
	</tr>
	
	
	<tr>
		<td class="bleu11">Date de fin</td>
		<td class="noir11" colspan="2"><input type="text" name="dateFin" id="date_fin" class="swing11"  maxlength="10"/>		
		<a href="#" onClick="Javascript:document.forms['CreationMessageForm'].dateFin.value=''"><img src="../img/CLEAR.gif" border="0" align="middle"></img></a></td>
	</tr>
...
<div align="center" style="padding-top:40px">
	...
	<input type="button" class="bouton_bleu" value="Cr&eacute;er" onClick="Javascript:creerMessage()" style="width:75px">
</div>
