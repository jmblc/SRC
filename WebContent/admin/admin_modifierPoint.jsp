...
<html>
	...
	<body onload="document.forms[0].libellePoint.focus()" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0">

	<form name="ModificationPointForm">
		<input type="text" name="champ_important_ne_pas_supprimer" style="visibility:hidden" >
		
		<div class="bleu12IB" style="width:100%;" align="center">MODIFICATION DE POINT</div>
		...
		<table cellpadding="4" cellspacing="4" border="0" width="100%">	
			...
			<tr>
				<td class="separateur" colspan="2" height="30px"><img src="../img/puce_point.gif">&nbsp;POINT</TD>	
			</tr>
			...
			<tr>
				<td class='bleu11'>Sous-motif p&egrave;re</td>
			...
			<tr>
				...
				<td><input type="text" name="libellePoint" value="<%=lePoint.getLibelle()%>" class="swing11" style="width:260px"  onkeypress="Javascript:doModifierPointClk()" maxlength="92"></input>&nbsp;<label class="noir10">(Max : 92)</label></td>
			</tr>
		...
		<div align="center" style="padding-top:40px">
			...
			<input type="button" class="bouton_bleu" value="Valider" onClick="Javascript:doModifierPoint()" style="width:75px">
		</div>
