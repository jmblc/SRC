...
<html>
	...
	<body onload="document.forms[0].libelleSousPoint.focus()" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0">
		<form name="CreationSousPointForm">	
		<input type="text" name="champ_important_ne_pas_supprimer" style="visibility:hidden" >
		
		<div class="bleu12IB" style="width:100%;" align="center">AJOUT DE SOUS-POINT</div>
		...
		<table cellpadding="4" cellspacing="4" border="0" width="100%">	
			...
			<tr>
				<td class='bleu11' nowrap="nowrap">Point p&egrave;re</td>
			...
			<tr>
				...
				<td><input type="text" name="libelleSousPoint" value="" class="swing11" style="width:260px" onkeypress="Javascript:doCreerSousPointClk()" maxlength="92"></input>&nbsp;<label class="noir11">(Max : 92)</label>
				</td>
			</tr>	
		...
		<div align="center" style="padding-top:40px">
			...
			<input type="button" class="bouton_bleu" value="Valider" onClick="Javascript:doCreerSousPoint()" style="width:75px">
		</div>
